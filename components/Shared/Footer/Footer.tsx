...
export const Footer = (props: Props) => {
  ...
  return (
    <section data-aos="fade-up" className="py-12 bg-gradient-to-r from-fuchsia-600 to-blue-600">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
          <div className="xl:flex xl:items-center xl:justify-start flex flex-col">
            <Image
              className="w-3/2 h-3/2 mx-auto rounded-full "
              src="/website/logo-enmanuel.png"
              alt="Aura UI Logo"
              height={200}
              width={200}
            />
